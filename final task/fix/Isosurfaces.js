function Isosurfaces( volume, isovalue, reflection, color, opacity )
{
    var vShader;
    var fShader;
		vShader = document.getElementById('Gouraud'+reflection+'.vert').text;
        fShader = document.getElementById('Gouraud.frag').text;
/*    if(shader == 'Gouraud')
        {
    ...
    /*****
     *param v: vertex
     *param s: isovalue(default:128)
     *****/
    function interpolated_vertex( v0, v1, s )
    {
        //Todo
        /*check volume of vertex -> s0 s1
         *compare s,s0,s1
         *interpolate according to the compare result
         *value = [(0,0,0),(1,0,0)...(x_resolution-1,0,0),(0,1,0)...] ?
         */
        //index of the volume value
